...
#include "Runtime/Engine/Public/EngineDefines.h"
#include "Runtime/Engine/Public/PhysxUserData.h"
#include "Runtime/Engine/Classes/PhysicsEngine/BodyInstance.h"
#include "Runtime/Engine/Classes/Components/SkinnedMeshComponent.h"
#include "RemoteDestructibleComponent.generated.h"

class AController;
class URemoteDestructibleComponent;
class USkeletalMesh;
...
struct FDestructibleChunkInfo
{
	...
	TWeakObjectPtr<class URemoteDestructibleComponent> OwningComponent;
};
#endif // WITH_PHYSX 
...
class EXJOBB_API URemoteDestructibleComponent : public USkinnedMeshComponent
{
	GENERATED_BODY()

public:
	URemoteDestructibleComponent();

	/** If set, use this actor's fracture effects instead of the asset's fracture effects. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = DestructibleComponent, meta = (AllowPrivateAccess = "true"))
